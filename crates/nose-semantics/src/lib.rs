...
use evidence::{
    ...
    unique_evidence_at, var_references_param_binding, var_references_same_binding,
    EvidenceResolution,
};
...
pub use language_profile::{
    ...
    language_core_evidence_provenance, language_source_fact_provenance, semantics, LanguageProfile,
    ...
    C_UNSIGNED_32_CAST_SOURCE_PRODUCER_ID, GO_LANGUAGE_CORE_PRODUCER_ID, GO_LANGUAGE_PACK_ID,
    ...
    JS_TS_LANGUAGE_CORE_PRODUCER_ID, JS_TS_LANGUAGE_PACK_ID, JS_TS_SOURCE_FACT_PRODUCER_ID,
