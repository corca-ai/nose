...
fn admitted_rust_result_predicate_requires_result_receiver_and_pack_provenance() {
    ...
    admitted.push_evidence(rust_stdlib_result_record(
        1,
...
fn admitted_rust_option_and_then_resolver_requires_pack_provenance() {
    ...
    wrong_emitter.push_evidence(evidence(
        0,
    ...
    admitted.push_evidence(rust_stdlib_option_record(
        1,
        admitted.node(call).span,
        contract.id,
        contract.callee,
...
fn admitted_free_function_builtin_resolver_requires_api_occurrence_evidence() {
    ...
    missing_dependency.push_evidence(free_function_builtin_protocol_record(
        0,
    ...
    admitted.push_evidence(free_function_builtin_protocol_record(
        1,
        admitted.node(call).span,
        contract,
        1,
...
fn admitted_imported_namespace_function_resolver_requires_pack_provenance() {
    ...
    missing_dependency.push_evidence(python_stdlib_math_record(
        0,
        missing_dependency.node(call).span,
        contract,
        1,
    ...
    wrong_arity.push_evidence(python_stdlib_math_record(
        2,
    ...
    admitted.push_evidence(python_stdlib_math_record(
        2,
        admitted.node(call).span,
        contract,
        1,
...
fn admitted_imported_namespace_function_rejects_broad_namespace_dependency() {
    ...
    il.push_evidence(python_stdlib_math_record(
        2,
        il.node(call).span,
        contract,
        1,
