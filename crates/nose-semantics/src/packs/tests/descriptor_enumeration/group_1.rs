...
pub(super) fn assert_group() {
    ...
    assert_eq!(sequence_hof_adapter.counts().positive_fixtures, 21);
    assert_eq!(sequence_hof_adapter.counts().hard_negatives, 52);
    ...
    assert!(sequence_hof_adapter
        .conformance_refs()
        .contains(&"swift-sequence-hof-filtered-flat-map-all-satisfy-positive"));
    assert!(sequence_hof_adapter
        .conformance_refs()
        .contains(&"swift-sequence-hof-flat-map-aggregate-custom-all-satisfy-hard-negative"));
    assert!(sequence_hof_adapter
        .conformance_refs()
        .contains(&"swift-sequence-hof-compact-map-positive"));
    assert!(sequence_hof_adapter
        .conformance_refs()
        .contains(&"swift-sequence-hof-compact-map-custom-overload-hard-negative"));
    assert!(sequence_hof_adapter
        .conformance_refs()
        .contains(&"swift-sequence-hof-compact-map-custom-nil-literal-hard-negative"));
    assert!(sequence_hof_adapter
        .conformance_refs()
        .contains(&"swift-sequence-hof-compact-map-derived-source-hard-negative"));
    assert!(sequence_hof_adapter
        .conformance_refs()
        .contains(&"swift-sequence-hof-compact-map-retroactive-nil-conformance-hard-negative"));
    assert!(sequence_hof_adapter
        .conformance_refs()
