...
- synthetic generation and manifest evaluation:
  ...
  `type4gen/` owns generator model/config, axis metadata and evidence,
  registry-validated domain policies, domain-independent case materialization,
  aggregate emitters, and source-template/cross-case modules split by scalar/null,
