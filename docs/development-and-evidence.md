...
This page collects the internal design notes, proof contracts, performance
records, release evidence, and historical closeouts used to develop nose. You
do not need these documents to use the tool. Start at the
[documentation home](home.md) for the user guide or
[contributing](contributing.md) to change the code.

Current architecture and workflow pages come first. Issue-numbered closeouts
and dated audits are retained as evidence for maintainers; they describe a
specific decision or measurement, not a user-facing feature contract.
