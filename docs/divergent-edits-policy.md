# Divergent-edit policy and qualification evidence

This is the maintainer record for the divergent-edit gate's evidence model,
schema, measured policy, and development qualification cycles. For day-to-day
commands and CI, start with the [divergent edits user guide](divergent-edits.md).
