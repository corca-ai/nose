...
arguments, opaque/user call-by-value arguments, a `Seq` literal, unary operands, index
bases/subscripts, or a map/filter/reduce lambda over a statically non-empty `Seq`, plus
