...
# neither member changed. The new surface-selection test reuses existing scaffolding, so no new
# avoidable duplication is accepted. See docs/dogfooding-history.md.
