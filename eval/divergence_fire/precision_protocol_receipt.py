...
ARTIFACT_COMMIT = "0c1b34075df833fc769873826adc9f6361b23e57"
ARTIFACT_PARENT = "124c10fb3104dafe5dc73c0710a0ce1a2cb78fe9"
ARTIFACT_TREE = "b675add7d9b07a6de0f00700146896887bd5d59c"
ARTIFACTS = (
    (
        "eval/divergence_fire/precision_protocol_2026_07_14.v2.json",
        "100644",
        "74f76e8b6e60dee8ab62814579b9c20edbc2a05a",
        400_879,
        "a6b90708edc4527eae6b30ef119153f078884f85f3ac650502da5b5e96318185",
    ),
    (
        "eval/divergence_fire/precision_protocol_2026_07_14.v2.json.sha256",
        "100644",
        "8dcb67c5399c6721da9b00b7c6ae68b4c79dc778",
        104,
        "883a2f92dc43bbab768db4e9ba0e4464403cc543daee6f3f825dededc3e27024",
    ),
)
ROOT_SEED_COMMITMENT = (
    "348096302212c8638f27cd8b239fd2ffba52aa1dcb7da82a2469ea7faa32feb1"
)
PRIVATE_PACKET_SHA256 = (
    "5a3d677d9c6f39d610a886b62a43980329ed2c3ccfc9c00321ce3a3643ea1229"
)
PRIVATE_PACKET_BYTES = 11_203_199
BLIND_REPOSITORIES = 28
BLIND_CHANGES = 1_120
BLIND_FINDING_SUPPORT = 100
BLIND_TARGET_SUPPORT = 100
BLIND_REPOSITORY_SUPPORT = 20
BLIND_REPOSITORY_PER_LANGUAGE_SUPPORT = 2
...
def receipt_record() -> dict[str, Any]:
    return {
        ...
        "blind_repository_per_language_support": (
            BLIND_REPOSITORY_PER_LANGUAGE_SUPPORT
        ),
...
def validate_document_receipt(record: dict[str, Any], payloads: dict[str, bytes]) -> None:
    ...
    require_equal(
        ...
        record["blind_repository_per_language_support"],
        "blind per-language repository support",
    )
...
def self_test(_: argparse.Namespace) -> None:
    ...
    value_mutations = (
        ...
        (
            "blind_repository_per_language_support",
            BLIND_REPOSITORY_PER_LANGUAGE_SUPPORT - 1,
        ),
