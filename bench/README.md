...
historical measurements those sections cite. The current artifact also reports how many
top-10 results match that frozen pool, so unlabeled results cannot disappear from the
coverage audit.
