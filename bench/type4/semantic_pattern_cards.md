...
| `quantifier.universal.counterexample-loop` | `real-pair-admitted` | 5 | 5 |
...
- hard-negative templates: `loop.changed-empty-result`, `loop.iterator-identity`, `loop.short-circuit`, `effect.observed-predicate-effect`, `effect.helper-call-without-purity-proof`, `boolean.value-context`, `boolean.comparison-complement`, `boolean.changed-predicate`, `array.sparse-hole`
...
| TypeScript | dense-literal Array.prototype.every plus a pure for-of counterexample loop over the same source with a one-argument value predicate; sparse-array parameters, index/source callback args, JS/TS value-returning predicates, and effects stay split | `admitted` | bench/type4/adversarial/cases/cases.v1.json::typescript_every_universal_positive; bench/type4/adversarial/cases/cases.v1.json::typescript_every_sparse_array_boundary; bench/type4/adversarial/cases/cases.v1.json::typescript_every_vacuous_truth_boundary; bench/type4/adversarial/cases/cases.v1.json::typescript_every_changed_predicate_boundary; bench/type4/adversarial/cases/cases.v1.json::typescript_every_source_identity_boundary; bench/type4/adversarial/cases/cases.v1.json::typescript_every_side_effect_boundary; bench/type4/adversarial/cases/cases.v1.json::typescript_every_callback_extra_args_boundary; bench/type4/adversarial/cases/cases.v1.json::typescript_every_value_return_boundary |
| JavaScript | Array.prototype.every plus a pure counterexample loop after exact Array receiver, value-returning, and callback-effect boundaries are closed | `open` |  |
...
| JS/TS | typed TypeScript reduce/some, dense-literal one-argument TypeScript every, and JS loop sum in the controlled slice; JavaScript every, TypeScript array-param every, callback index/source args, and untyped relational terminals remain open | `modeled-controlled` | bench/type4/adversarial/cases/cases.v1.json::reduction_sum_step_positive; bench/type4/adversarial/cases/cases.v1.json::reduction_any_all_terminal_positive; bench/type4/adversarial/cases/cases.v1.json::typescript_every_universal_positive; bench/type4/adversarial/cases/cases.v1.json::typescript_every_sparse_array_boundary; bench/type4/adversarial/cases/cases.v1.json::typescript_every_callback_extra_args_boundary |
